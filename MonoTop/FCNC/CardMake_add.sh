...
cardDir=MadGraph5Cards_add
copyDir=MadGraph5Cards_add/Vector_MonoTop_NLO_Mphi-1250_Mchi-150_gSM-0p25_gDM-1p0_13TeV-madgraph
copyMass=Vector_MonoTop_NLO_Mphi-1250_Mchi-150_gSM-0p25_gDM-1p0_13TeV-madgraph
modelName=DMsimp_s_spin1_monotop_${Med}_${DM}_800
targetDir=Vector_MonoTop_NLO_Mphi-${Med}_Mchi-${DM}_gSM-0p25_gDM-1p0_13TeV-madgraph
echo "copy cards from = ${copyDir}"
echo "copy model from = ${modelName}"
